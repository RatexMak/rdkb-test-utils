...
public class BroadBandWebGuiElements {
	...
	/** Xpath to select Disable entire Firewall in CUSTOM firewall */
	public static final String XPATH_DISABLE_ENTIRE_FIREWALL = "//*[@id=\"disable_firewall\"] | //*[@id=\"firmess17\"]";

	/** Element ID to select CUSTOM firewall */
	public static final String XPATH_CUSTOM_FIREWALL_LINK = "//*[@id=\"cussec\"] | //*[@id=\"custom\"]/label";

	/**
	 * xpath for popup message obtained on clicking ethwan enable/disable buttons
	 */
	public static final String XPATH_FOR_ETHWAN_POPUP_MESSAGE = "//*[@id=\"popup_message\"]";
	...
	/**
	 * Xpath for retype password error message in Gateway > Wizard Screen from
	 * connected client
	 */
	public static final String XPATH_FOR_RETYPE_PASSWORD_ERROR_UI_PORTAL = "//*[@id=\"pageForm\"]/div[3]/p";

	/**
	 * Xpath for current password error message in Gateway > Wizard Screen from
	 * connected client
	 */
	public static final String XPATH_FOR_CURRENT_PASSWORD_ERROR_UI_PORTAL = "//*[@id=\"pageForm\"]/div[1]/p";

	/**
	 * Xpath for new password error message in Gateway > Wizard Screen from
	 * connected client
	 */
	...
	/**
	 * Variable to store the web element Xpath Online Devices host name in Connected
	 * Devices pages
	 */
	public static final String ELEMENT_XPATH_ONLINE_DEVICES_HOST_NAME = "//*[@id=\"online-private\"]/table/tbody/tr[##ROW##]/td[1]/a/u";

	/**
	 * Variable to store the web element Xpath Online Devices connection type in
	 * Connected Devices pages
	 */
	public static final String ELEMENT_XPATH_ONLINE_DEVICES_CONNECTION_TYPE = "//*[@id=\"online-private\"]/table/tbody/tr[##ROW##]/td[4]";

	/**
	 * Variable to store the web element Xpath Online Devices info in Connected
	 * Devices pages
	 */
	...
	/**
	 * Variable to store the web element id for show password element in WiFi edit
	 * page
	 */
	...
	/** Element ID to select medium firewall */
	public static final String ELEMENT_ID_MEDIUM_FIREWALL = "firewall_level_typical";
	...
	/**
	 * Variable to store the web element of Enable in Managed sites in Parental
	 * Control
	 */
	...
	/**
	 * Variable to store the web element of Add Sites in Managed Site in Parental
	 * Control
	 */
	...
	/**
	 * Variable to store the web element of Save button in Add Blocked sites page in
	 * Parental Control
	 */
	...
	/**
	 * Variable to store the web element of Add Keyword in Managed Site in Parental
	 * Control
	 */
	public static final String XPATH_PARENTAL_CONTROL_MANAGED_SITES_ADD_KEYWORD_TEXT_BOX = "//*[@id=\"keyword\"]";

	/**
	 * Variable to store the web element of User Defined Service text box in Managed
	 * Service add page in Parental Control
	 */
	...
	/**
	 * Variable to store the web element of Add Services in Managed Service page in
	 * Parental Control
	 */
	public static final String ELEMENT_XPATH_PARENTAL_CONTROL_MANAGED_SERVICE_ADD_SERVICES = "//*[@id=\"add-blocked-services\"]";

	/**
	 * Variable to store the web element of Disable in Managed Service in Parental
	 * Control
	 */
	...
	/**
	 * Variable to store the web element Xpath Online Devices edit page reserved IP
	 * Radio button
	 */
	public static final String XPATH_ONLINE_DEVICES_EDIT_PAGE_RESERVED_IP_RADIO_BUTTON = "//div[##ROW##]/div[2]/form/div[3]/input[2]";

	/** Variable to store the xpath for WAN Default Gateway Address (IPv6)=Bussiness class device */
	public static String XPATH_FOR_WAN_DEFAULT_GATEWAY_ADDRESS_IPV6_BUSSINESS_DEVICE = "//*[@id=\"content\"]/div[2]/div[8]/span[2]";
    
    /** Variable to store the xpath for WAN Default Gateway Address (IPv6) */
    public static String XPATH_FOR_WAN_DEFAULT_GATEWAY_ADDRESS_IPV6 = "//*[@id=\"content\"]/div[2]/div[7]/span[2]";
    
    /** Variable to store the xpath for Delegated prefix (IPv6)-BUSSINESSCLASS_DEVICE */
    public static String XPATH_FOR_DELEGATED_PREFIX_IPV6_BUSSINESSCLASS_DEVICE = "//*[@id=\"content\"]/div[2]/div[9]/span[2]";
    
    /** Variable to store the xpath for Primary DNS Server IPV6 -Bussiness class device */
    public static String XPATH_FOR_PRIMARY_DNS_SERVER_IPV6_BUSSINESS_DEVICE = "//*[@id=\"content\"]/div[2]/div[12]/span[2]";
  
    /** Variable to store the xpath for Primary DNS Server IPV6 */
    public static String XPATH_FOR_PRIMARY_DNS_SERVER_IPV6 = "//*[@id=\"content\"]/div[2]/div[11]/span[2]";
    
    /** Variable to store the xpath for Secondary DNS Server IPV6-Bussiness class device */
    public static String XPATH_FOR_SECONDARY_DNS_SERVER_IPV6_BUSSINESS_DEVICE = "//*[@id=\"content\"]/div[2]/div[13]/span[2]";

    /** Variable to store the xpath for Secondary DNS Server IPV4 */
    public static String XPATH_FOR_SECONDARY_DNS_SERVER_IPV6 = "//*[@id=\"content\"]/div[2]/div[12]/span[2]";
    
    /** Variable to store the xpath for WAN IP Address (IPv6) */
    public static String XPATH_FOR_WAN_IP_ADDRESS_IPV6_BUSSINESS_DEVICE = "//*[@id=\"content\"]/div[2]/div[7]/span[2]";
    
    /** Variable to store the xpath for WAN IP Address (IPv6) */
    public static String XPATH_FOR_WAN_IP_ADDRESS_IPV6 = "//*[@id=\"content\"]/div[2]/div[6]/span[2]";
    
    /** Variable to store the xpath for WAN Link Local Address-Bussiness class device */
    public static String XPATH_FOR_WAN_LINK_LOCAL_ADDRESS_IPV6_BUSSINESS_CLASS = "//*[@id=\"content\"]/div[2]/div[14]/span[2]";

    /** Variable to store the xpath for WAN Link Local Address */
    public static String XPATH_FOR_WAN_LINK_LOCAL_ADDRESS_IPV6 = "//*[@id=\"content\"]/div[2]/div[13]/span[2]";
    
    /** xpath for doscis downstream table elements */
    public static final String XPATH_DOCSIS_DOWNSTREAM_TABLE = "//div[@id='content']/div[<REPLACE>]/table/tbody/tr[##ROW##]/td[##DIV1##]/div";
    
    /**
     * Variable to store the web element Xpath Offline Devices host name in Connected Devices pages
     */
    public static final String ELEMENT_XPATH_OFFLINE_DEVICES_HOST_NAME = "//*[@id=\"offline-private\"]/table/tbody/tr[##ROW##]/td[1]/a/u";
    
    /**
     * Variable to store the web element Xpath Offline Devices info in Connected Devices pages
     */
    public static final String ELEMENT_XPATH_OFFLINE_DEVICES_INFO = "//*[@id=\"offline-private\"]/table/tbody/tr[##ROW##]/td[1]/div/dl";
    
    /** Channel bandwidth 80Mhz id in wifi page of Lan side gui */
    public static final String ELEMENT_ID_CHANNEL_80MHZ = "channel_bandwidth2";
