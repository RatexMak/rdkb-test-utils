...
public class BroadBandWebPaConstants {
	...
	/**
	 * Webpa parameter to get
	 * Device.DeviceInfo.X_RDKCENTRAL-COM_Syndication.RDKB_Control.ActivatePartnerId
	 */
	...
	/**
	 * WebPA parameter to get the SSID Advertisement enabled status for 2.4 GHz
	 * Wi-Fi network.
	 */
	...
	/**
	 * WebPA parameter to get the SSID Advertisement enabled status for 5 GHz Wi-Fi
	 * network.
	 */
	...
	/**
	 * WebPA parameter representation for
	...
	/**
	 * WebPA parameter representation for
	 * Device.WiFi.AccessPoint.10101.Security.KeyPassphrase
	 */
	...
	/**
	 * WebPA Parameter to represent Number of allowed clients for 2.4 GHz Secure
	 * SSID
	 */
	...
	/**
	 * webpa parameter to validate wireless ssid enable status for Lost and Found
	 * 2.4GHz
	 */
	...
	/**
	 * WebPa parameter for device reboot. The value should be of string type -
	 * "Device"
	 */
	...
	public enum NonDefaultWiFiParametersEnum {
		...
		NONDEFAULT_VALUE_SECURITY_MODE_2_4(
				...
				"WPA2-Enterprise", 0),
		NONDEFAULT_VALUE_CHANNEL_MODE_2_4(BroadBandWebPaConstants.WEBPA_PARAM_FOR_WIFI_AUTOCHANNELENABLE_STATUS_2GHZ,
				"false", 3),
		NONDEFAULT_VALUE_BANDWIDTH_2_4(BroadBandWebPaConstants.WEBPA_PARAM_FOR_OPERATING_BANDWIDTH_IN_2GHZ_BAND,
				"20MHz", 0),
		NONDEFAULT_VALUE_GUARD_INTERVAL_2_4(BroadBandWebPaConstants.WEBPA_PARAM_FOR_GUARD_INTERVAL_IN_2GHZ, "800nsec",
				0),
		NONDEFAULT_VALUE_NETWORK_NAME_ENABLED_2_4(
				BroadBandWebPaConstants.WEBPA_PARAM_DEVICE_WIFI_2_4_GHZ_PRIVATE_SSID_ADV_ENABLED, "false", 3),
		NONDEFAULT_VALUE_NETWORK_ACTIVE_STATUS_2_4(
				BroadBandWebPaConstants.WEBPA_PARAM_DEVICE_WIFI_2_4_GHZ_PRIVATE_SSID_ENABLED_STATUS, "false", 3),
		NONDEFAULT_VALUE_OPERATING_STANDARD_2_4(
				BroadBandWebPaConstants.WEBPA_PARAM_DEVICE_WIFI_RADIO_10000_OPERATINGSTANDARDS, "n", 0),
		NONDEFAULT_VALUE_RADIO_STATUS_2_4(BroadBandWebPaConstants.WEBPA_PARAM_WIFI_2_4_RADIO_ENABLE, "false", 3),
		NONDEFAULT_VALUE_RADIO_CHANNEL_2_4(BroadBandWebPaConstants.WEBPA_PARAM_DEVICE_WIFI_RADIO_CHANNEL_IN_2GHZ, "3",
				2),
		...
		NONDEFAULT_VALUE_SECURITY_MODE_5(
				...
				"WPA2-Enterprise", 0),
		NONDEFAULT_VALUE_CHANNEL_MODE_5(BroadBandWebPaConstants.WEBPA_PARAM_FOR_WIFI_AUTOCHANNELENABLE_STATUS_5GHZ,
				"false", 3),
		NONDEFAULT_VALUE_BANDWIDTH_5(BroadBandWebPaConstants.WEBPA_PARAM_FOR_OPERATING_BANDWIDTH_IN_5GHZ_BAND, "40MHz",
				0),
		...
		NONDEFAULT_VALUE_NETWORK_NAME_ENABLED_5(
				BroadBandWebPaConstants.WEBPA_PARAM_DEVICE_WIFI_5_GHZ_PRIVATE_SSID_ADV_ENABLED, "false", 3),
		NONDEFAULT_VALUE_NETWORK_ACTIVE_STATUS_5(
				BroadBandWebPaConstants.WEBPA_PARAM_DEVICE_WIFI_5_GHZ_PRIVATE_SSID_ENABLED_STATUS, "false", 3),
		NONDEFAULT_VALUE_OPERATING_STANDARD_5(
				BroadBandWebPaConstants.WEBPA_PARAM_DEVICE_WIFI_RADIO_OPERATINGSTANDARDS_IN_5GHZ, "n", 0),
		NONDEFAULT_VALUE_RADIO_STATUS_5(BroadBandWebPaConstants.WEBPA_PARAM_WIFI_5_RADIO_ENABLE, "false", 3),
		NONDEFAULT_VALUE_RADIO_CHANNEL_5(BroadBandWebPaConstants.WEBPA_PARAM_DEVICE_WIFI_RADIO_CHANNEL_IN_5GHZ, "52",
				2);
		...
		/**
		 * @param webPaParam the webPaParam to set
		 */
		...
		/**
		 * @param webPaValue the webPaValue to set
		 */
	...
	/**
	 * enum variable to store default values of wifi parameters in 2.4Ghz after
	 * factory reset
	 */
	...
	public enum RdkBWifiParameters {
		...
		SECURITY_MODE_2GHZ_PRIVATE_WIFI_WPA3("Device.WiFi.AccessPoint.10001.Security.ModeEnabled", "WPA3-Personal-Transition"),
		SECURITY_MODE_5GHZ_PRIVATE_WIFI_WPA3("Device.WiFi.AccessPoint.10101.Security.ModeEnabled", "WPA3-Personal-Transition"),
		...
		OPERATING_CHANNEL_BANDWIDTH_2GHZ_FOR_FIBRE_DEVICES("Device.WiFi.Radio.10000.OperatingChannelBandwidth",
				"40MHz"),
	...
	/**
	 * webpa parameter to get the value of
	...
	/**
	 * Map with snmp Name as key and corresponding webpa parameter as value to pass
	 * the webpa parameter as argument and fetch the webpa response.
	 */
	...
	/**
	 * WebPA parameter to enable/disable SSIDAdvertisementEnabled of Public
	 * Wifi(open) 2.4 GHz Network
	 */
	...
	/**
	 * WebPA Parameter for getting Device Wifi Accesspoint MacFilter Table in 5GHZ
	 * network
	 */
	...
	/**
	 * WebPA Parameter for getting Device Wifi Accesspoint MacFilter Black List in
	 * 5GHZ network
	 */
	...
	/**
	 * WebPA Parameter for getting Device Wifi Accesspoint MacFilter mode in 5GHZ
	 * network
	 */
	...
	/**
	 * WebPA Parameter for getting Device Wifi Accesspoint MacFilter Table in 2.4GHZ
	 * network
	 */
	...
	/**
	 * WebPA Parameter for Device Wifi Accesspoint MacFilter Enable in 2.4GHZ
	 * network
	 */
	...
	/**
	 * WebPA Parameter for getting Device Wifi Accesspoint MacFilter mode in 2.4GHZ
	 * network
	 */
	...
	/**
	 * webpa parameter to get the value of
	 * Device.WiFi.AccessPoint.10001.SSIDReference
	 */
	...
	/**
	 * webpa parameter to get the value of
	 * Device.WiFi.AccessPoint.10001.Security.ModesSupported
	 */
	...
	/**
	 * webpa parameter to get the value of
	 * Device.WiFi.AccessPoint.10001.MaxAssociatedDevices
	 */
	...
	/**
	 * webpa parameter to get the value of
	 * Device.WiFi.AccessPoint.10001.AssociatedDeviceNumberOfEntries
	 */
	...
	/**
	 * WebPa Parameter for the object
	...
	/**
	 * WebPa parameter for
	 * Device.DeviceInfo.X_RDKCENTRAL-COM_RFC.Feature.BLE.Discovery
	 */
	...
	public static enum DeviceManagementServerParams {
		...
		DEVICE_MANAGEMENT_ACTIVE_NOTIFICATION_THROTTLE("Device.ManagementServer.DefaultActiveNotificationThrottle",
				" "),
		...
		/**
		 * @param valueToCheck the valueToCheck to set
		 */
