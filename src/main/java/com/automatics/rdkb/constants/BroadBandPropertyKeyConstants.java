...
public class BroadBandPropertyKeyConstants {
	...
	/**
	 * property to configure valid Gateway local DHCP Start address in setting
	 * Gateway Ip
	 */
	public static final String PROP_KEY_TEST_GATEWAY_LOCAL_DHCP_START_ADDR = "test.gateway.localdhcp.startaddr";

	/**
	 * property to configure valid Gateway local DHCP end address in setting Gateway
	 * Ip
	 */
	...
	/**
	 * property to retrive a part of buildname to check its contains in the
	 * buildname
	 */
