...
public class BroadBandTestConstants extends RDKBTestConstants {
	...
	public enum WINDOWS_WIRELESS_MODE_OPTIONS {
		A_802_11("802.11a", "17"), B_802_11("802.11b", "0"), G_802_11("802.11g", "16"), B_G_802_11("802.11b/g", "32"),
		A_G_802_11("802.11a/g", "18"), A_B_G_802_11("802.11a/b/g", "34");
	...
	/** Command ARP */
	public static final String COMMAND_ARP_FOR_WINDOWS = "arp -a";
	...
	/**
	 * String to store pattern to get value of BandSteeringEnabledTest parameter in
	 * dcmscript.log
	 */
	...
	/**
	 * Test constant for applying Dns ovverride at client MAC level IPv4 null value
	 * 00.00.00.00
	 */
	...
	/**
	 * Test constant for applying Dns ovverride at client MAC level IPv4 level two
	 * primary value 75.75.75.20
	 */
	...
	/**
	 * Test constant for dnsoverride level one block site address in stb.properties
	 * file
	 */
	public static final String PROP_KEY_DNS_BLOCK_ADDRESS_FOR_LEVEL_ONE_SITE = "dnsoverride.blocksiteaddress.level.one";

	/**
	 * Test constant for applying Dns ovverride at client MAC level IPv6 level two
	 * primary value 2001:558:feed::7520
	 */
	...
	/**
	 * Test constant for dnsoverride level two block site address in stb.properties
	 * file
	 */
	...
	/**
	 * Test constant for dnsoverride level three block site address in
	 * stb.properties file
	 */
	...
	/**
	 * The array list of Applicable Values for InterfaceDevicesWifi
	 * InterfaceDevicesWifiExtender NetworkDevicesStatus Harvester Parameters
	 */
	...
	/**
	 * The hash map to store the bridge mode status mapping with corresponding
	 * Integer value retrieved using SNMP.
	 */
	...
	/**
	 * The hash map to store the WIFI radio operating standards mapping with
	 * corresponding Integer value retrieved using SNMP.
	 */
	...
	/**
	 * value of reporting period/polling period to be set for network device status
	 * in seconds
	 */
	...
	/**
	 * The hash map to store the wifi radio Access point mapping with corresponding
	 * digits
	 */
	public static final Map<String, String> WIFI_RADIO_MAPPING = wifiRadiomapping();

	/**
	 * Method to create a map to store the Wifi Radio mapping with corresponding
	 * digits.
	 * 
	...
	/**
	 * Variable to hold Pop Up message for Start Block time greater than End Block
	 * time in Parental Control
	 */
	...
	/**
	 * Property key for rfc payload data in stb.props to set ForwardSSH with an
	 * invalid string
	 */
	...
	/**
	 * ENUM WHICH STORES ALL THE REQUIRED Public WiFi hotspot WEBPA PARAMS for
	 * predefined values
	 */
