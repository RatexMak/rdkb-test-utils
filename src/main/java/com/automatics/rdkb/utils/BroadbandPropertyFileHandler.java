...
public class BroadbandPropertyFileHandler {
	...
	/**
	 * This API will get the specific Device in which default values of OVS Bridge
	 * control and Linux Bridge Control values are expected as in test from
	 * properties
	 * 
	 * @author Said Hisham
	 */
	...
	/**
	 * This API will get the Default Bandsteering Enable value of the device from
	 * properties
	 * 
	 * @author Said Hisham
	 */
	...
	/**
	 * This API will get the private host ip 1 address outside range for netcat from
	 * properties
	 * 
	 * @author Said Hisham
	 */
	...
	/**
	 * This API will get the private host ip 2 address outside range for netcat from
	 * properties
	 * 
	 * @author Said Hisham
	 */
	...
	/**
	 * This API will get the private host ip 3 address outside range for netcat from
	 * properties
	 * 
	 * @author Said Hisham
	 */
	...
	/**
	 * This API will get the private host ip 4 address outside range for netcat from
	 * properties
	 * 
	 * @author Said Hisham
	 */
	...
	/**
	 * This API will get the Atom Sync Devices For Broadband Activation Event from
	 * properties
	 * 
	 * @author yamini.s
	 */
	...
	/**
	 * This API will get the Fiber Devices For Broadband Activation Event from
	 * properties
	 * 
	 * @author yamini.s
	 */
	...
	/**
	 * This API will get the all the Devices For Broadband Activation Event where
	 * the logs are generated in Sec_Console file from properties
	 * 
	 * @author yamini.s
	 */
	...
	/**
	 * This API will get the all the Devices For Broadband Activation Event where
	 * the logs are generated in Console_log.txt.0 file from properties
	 * 
	 * @author yamini.s
	 */
	...
	/**
	 * This API will get the all the Devices For Broadband Activation Event
	 * LAN_INIT_START from properties
	 * 
	 * @author yamini.s
	 */
	...
	/**
	 * This API will get the all the Devices For Broadband Activation Event
	 * LANINIT_COMPLETE from properties
	 * 
	 * @author yamini.s
	 */
	...
	/**
	 * This API will get the all the Devices For Broadband Activation Event
	 * WAN_INIT_START from properties
	 * 
	 * @author yamini.s
	 */
	...
	/**
	 * This API will get the all the Devices For Broadband Activation Event
	 * WANINIT_COMPLETE from properties
	 * 
	 * @author yamini.s
	 */
	...
	/**
	 * This API will get the all the Devices For Broadband Activation Event
	 * CLIENT_CONNECT from properties
	 * 
	 * @author yamini.s
	 */
	...
	/**
	 * This API will get the all the Devices For Broadband Activation Event
	 * WIFI_NAME_BROADCAST for 2.4Ghz from properties
	 * 
	 * @author yamini.s
	 */
	public static String getApplicableDevicesForWifi_name_broadcast_2_4Event() {
		return AutomaticsTapApi.getSTBPropsValue(
				BroadBandPropertyKeyConstants.DEVICES_BROADBAND_ACTIVATION_EVENT_WIFI_NAME_BROADCAST_2_4);
	}

	/**
	 * This API will get the all the Devices For Broadband Activation Event
	 * WIFI_NAME_BROADCAST for 5Ghz from properties
	 * 
	 * @author yamini.s
	 */
	public static String getApplicableDevicesForWifi_name_broadcast_5Event() {
		return AutomaticsTapApi.getSTBPropsValue(
				BroadBandPropertyKeyConstants.DEVICES_BROADBAND_ACTIVATION_EVENT_WIFI_NAME_BROADCAST_5);
	}

	/**
	 * This API will get the all the Devices For Broadband Activation Event
	 * WIFI_BROADCAST_COMPLETE from properties
	 * 
	 * @author yamini.s
	 */
	public static String getApplicableDevicesForWifi_broadcast_completeEvent() {
		return AutomaticsTapApi.getSTBPropsValue(
				BroadBandPropertyKeyConstants.DEVICES_BROADBAND_ACTIVATION_EVENT_WIFI_BROADCAST_COMPLETE);
	}

	/**
	 * This API will get the all the Devices For Broadband Activation Event
	 * WIFI_PERSONALIZATION_CAPTIVE_MODE from properties
	 * 
	 * @author yamini.s
	 */
	public static String getApplicableDevicesForWifiPersonilizationCaptiveEvent() {
		return AutomaticsTapApi.getSTBPropsValue(
				BroadBandPropertyKeyConstants.DEVICES_BROADBAND_ACTIVATION_EVENT_WIFI_PERSONALIZATION_CAPTIVE);
	}

	/**
	 * This API will get the partner where the Captive Portal is disabled by default
	 * from properties
	 * 
	 * @author yamini.s
	 */
	public static String getCaptivePortalDefaultDisabledPartner() {
		return AutomaticsTapApi.getSTBPropsValue(BroadBandPropertyKeyConstants.CAPTIVE_PORTAL_DEFAULT_DISABLED_PARTNER);
	}
	...
	/**
	 * This API will get the Default Resource Usage ComputeWindow of the device from
	 * properties
	 * 
	 * @author Said Hisham
	 */
	public static String getResourceUsageComputeWindowFromProperty() {
		return AutomaticsTapApi.getSTBPropsValue(BroadBandPropertyKeyConstants.RESOURCE_USAGE_COMPUTE_WINDOW_VALUE);
	}
	...
	public static String getCommandForIDSinSyscfg() {
		return AutomaticsTapApi.getSTBPropsValue(BroadBandPropertyKeyConstants.GREP_IDS_SYSCFG);
	}
	...
	public static String get5ghzInterfaceName() {
		return AutomaticsTapApi.getSTBPropsValue(BroadBandPropertyKeyConstants.GET_5_GHZ_INTERFACE_NAME);
	}
