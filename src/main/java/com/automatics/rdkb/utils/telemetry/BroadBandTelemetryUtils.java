...
public class BroadBandTelemetryUtils {
     ...
     * @param device
     *            {@link Dut}
     * @return Boolean representing the result of the clearing telemetry configuration files.
     * @refactor Govardhan
     */
    ...
    /**
     * 
     * Helper method to copy and to update the dcm.properties with the XCONF update url
     * 
     * @param tapEnv
     *            {@link AutomaticsTapApi}
     * @param device
     *            {@link Dut}
     * @return status 0 box doesn't contain /etc/dcm.properties file 1 XCONF URL Updated Successfully 3 Failed to update
     *         the LOG UPLOAD XCONF URL
     * @refactor Govardhan
     */
    ...
    /**
     * Helper Method to configure the Telemetry Profile for Invalid Ping Servers Configuration Telemetry Markers. It
     * clears the existing telemetry configuration files on the device. Then copies the dcm.properties from /etc to
     * /nvram directory & updates with the appropriate DCM Log Server URL. Then configure the XCONF server with required
     * telemetry markers for the device.
     * 
     * @param tapEnv
     *            {@link AutomaticsTapApi}
     * @param device
     *            {@link Dut}
     * @return Boolean representing the result of Invalid Ping Servers Configuration Telemetry Profile Configuration.
     * @refactor Govardhan
     */
    ...
    /**
     * Method to reset default values of configurable telemetry tag control parameters
     * 
     * @param device
     *            {@link Dut}
     * @param tapApi
     ...
     *            {@link AutomaticsTapApi}
     * @param filePath
     *            The file in the url need to be searched
     * @param reqdUrl
     *            The expected log server url
    ...
    /**
     * Utility method to get the Telemetry Data Pay Load generated from Splunk for T2
     * 
     * @param device
     *            The device under test
     * @param tapEnv
    ...
    /**
     * Utility method to get the Telemetry Data Pay Load generated from dcmscript.log
     * 
     * @param device
     *            The device under test
     * @param tapEnv
    ...
    /**
     * Method to get syndication partner id using webpa param Device.DeviceInfo.X_RDKCENTRAL-COM_Syndication.PartnerId
     * 
     * We will try to get the partner id using webpa parameter if the parameter is not available in any device we will
     * take Property file as partner id
     * 
     * @param tapEnv
     *            {@link AutomaticsTapApi}
     * @param settop
    ...
    /**
     * helper method to configure /nvram/swupdate.conf with the XCONF update URL. URL is same for both IPv4 and IPv6
     * 
     * @param device
     *            instance of DUT
     * @param tapApi
     *            instance of {@link AutomaticsTapApi}
     * @return true if successfully updated /nvram/swupdate.conf file with given xconfUpdateUrl
     * @refactor Said hisham
     */
