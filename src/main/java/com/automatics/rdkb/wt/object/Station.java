...
/**
 * POJO class to store Station details The mandatory parameters needed to create
 * a station in LANForge are alias, ssid, psk, radio and the optional parameters
 * are mode and ethernet_interface
 * 
 * @author Arun V S
 * @author sreejasuma
 *
...
public class Station {
	...
	/**
	 * Set station mode (6 for 2.4Gz, 9 for 5 Gz) Optional parameter used to create
	 * a station
	 * 
	 * @param mode
	 */
	...
	/**
	 * Set alias for station (starts with sta{number}, number max upto 6500)
	 * Mandatory parameter used to create a station
	 * 
	 * @param alias
	 */
	 ...
	 */
	/*
	 * public void setConnectionStatusOld(String connectionStatusOld) {
	 * this.connectionStatusOld = connectionStatusOld; }
	 */
	...
	/**
	 * Set ethernet interface (For LANForge) Optional parameter used to create a
	 * station. If not set default parameter will be set (ie eth1)
	 * 
