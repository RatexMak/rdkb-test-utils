...
public class BroadBandPreConditionUtils {
     ...
     * @param device
     *            {@link Dut}
     * @return defaultDchpIpv4ValuesMap Its return the key and pair value for default dhcp v4 values
     * @refactor Govardhan
     */
    ...
    /**
     * Precondition to validate Wifi client IPv4,Ipv6 ,connectivity status for 2.4GHZ OR 5GHZ
     * <ol>
     * <li>1 : OBTAIN A WIFI CLIENT ASSOSIATED WITH THE GATEWAY</li>
     * <li>2 : VERIFY THE CORRECT IPV4 ADDRESS FOR LAN CLIENT</li>
	...
	/**
	 * PRECONDITION 4 : VERIFY THE INTERNET CONNECTIVITY IN THE WIFI CLIENT INTERFACE USING IPV4 .
	 */
	status = false;
	LOGGER.info("#######################################################################################");
	LOGGER.info(
	...
	/**
	 * PRECONDITION 5 : VERIFY THE INTERNET CONNECTIVITY IN THE WIFI CLIENT INTERFACE USING IPV6 .
	 */
	status = false;
	LOGGER.info("#######################################################################################");
	LOGGER.info(
    ...
    /**
     * Pre-Condition method to verify the below condition in Ethernet connected Client .
     * 
    ...
    /**
     * Precondition to connect to Ethernet client, Validate IPv4, Ipv6, connectivity status for both IPs's.
     * <ol>
     ...
     * @param device
     *            {@link Instanceof Dut}
     * @param preConditionStepNum
     *            precondition step number
     * @refactor Rakesh C N
     */
	...
	try {
	    /**
	     * PRE-CONDITION : VERIFY THE PRIVATE WIFI 2.4 GHZ AND 5 GHZ SSID'S ARE BROADCASTING IN CONNECTED CLIENT
	     */
	    status = false;
	    errorMessage = null;
	    LOGGER.info("#####################################################################################");
