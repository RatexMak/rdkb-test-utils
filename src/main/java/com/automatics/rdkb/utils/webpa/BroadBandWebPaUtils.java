...
public class BroadBandWebPaUtils {
	 ...
	 * @param webpaParameter  The webpa parameter that has to be passed.
	 * @param dataType        Data type of the value.
	 * @param valueToBePassed Value that has to be passed.
	...
	/**
	 * Helper Method to verify the WebPA is up & running. Verified using WebPA
	 * command execution against a sample parameter 2.4 GHz Private SSID Name.
	 * 
	 * @param tapEnv      {@link AutomaticsTapApi}
	 * @param device      {@link Dut}
	 * @param pollProcess Boolean representing whether polling needs to be performed
	 *                    for validation or NOT.
	 * 
	 * @return Boolean representing the result of operation; TRUE if WebPA Command
	 *         Execution returns value; else FALSE
	 * @author Govardhan
	 */
	...
	/**
	 * Utility Method to get parameter value using WebPA command. If WebPA fails
	 * fall back to DMCLI to query same parameter. This method is only used for
	 ...
	 * 
	 * @param string parametername @ param string value @ param int dataType
	 * 
	 ...
	 * @param device           {@link Dut}
	 * @param tapEnv           {@link AutomaticsTapApi}
	 * @param webPaParam       WebPa parameter name
	 * @param valueToBeMatched value to be matched with the webpa response
	 * @param maxDuration      maximum polling duration
	 * @param pollDuration     wait time for each itration
	 * @return status
	 * @author Govardhan
	 * 
	 */
	...
	/**
	 * Helper method to set parameter values using WebPA command then get value
	 * after wait period and verify
	 * 
	 * @param device          The Dut to be used.
	 * @param tapEnv          The {@link AutomaticsTapApi} instance.
	 * @param webpaParameter  The webpa parameter that has to be passed.
	 * @param dataType        Data type of the value.
	 * @param valueToBePassed Value that has to be passed.
	 * @param waitDuration    value in milliseconds to wait for after setting value
	 * @return status Boolean representing the result of set and get actions.
	 * 
	 * @author Govardhan
	 */
	...
	/**
	 * Method to do polled set of WebPA parameter, then poll get operation for
	 * specified duration and verify value is set.
	 * 
	 * @param device          The Dut to be used.
	 * @param tapEnv          The {@link AutomaticsTapApi} instance.
	 * @param webpaParameter  The webpa parameter that has to be passed.
	 * @param dataType        Data type of the value.
	 * @param valueToBePassed Value that has to be passed.
	 * @param maxDuration     value in milliseconds to totally poll for
	 * @param pollDuration    value in milliseconds to wait for in between checks
	 ...
	 * @param parameter         TR-181 parameter name
	 * @param valueToBeVerified value to be verified.
	 ...
	 * @param setValue
	 * @return true, if webpa set value and get ouput are same and Telemetry marker
	...
	/**
	 * Utility method to check Appropriate Telemetry markers are present in
	 * /rdklogs/logs/WiFilogs.txt.0 file after setting the security mode
	 * 
	 * @param device    The device to be validated
	 * @param tapEnv    {@link AutomaticsTapApi} Reference
	 * @param setValue  Contains the Security mode that is being verified
	 * @param timeStamp Contains the Current time stamp in device
	 * @return
	 */
	...
	/**
	 * Utility Method to set and get parameter values using WebPA command or Dmcli
	 * Command
	 * 
	 ...
	 * @param webPaParameters The list of {@link WebPaParameter}
	 ...
	 * 
	 * @param device          The Dut to be queried
	 * @param tapEnv          The {@link AutomaticsTapApi} instance
	 * @param webPaParameters The list of webpa parameters.
	 */
	 ...
	 * @param tapEnv       The {@link AutomaticsTapApi} instance.
	 * @param bridgeStatus Boolean value containing true/false for enable/disable
	 *                     bridge mode
	 * @param meshStatus   Boolean value containing value of mesh enable to be set
	 ...
	 * @param parameters The array of parameters to be queried.
	...
	/**
	 * Utils method to check read-only attribute of WebPA parameter from WebPa Set
	 * Response
	 * 
	...
	/**
	 * Utils method to calculate end to end and box processing time for WebPA
	 * operations
	 * 
	 * @param tapEnv
	 * @param device
	...
	/**
	 * Utility method to retrieve the CMTS MAC address using WebPA parameter
	 * Device.DeviceInfo.X_RDKCENTRAL-COM_CMTS_MAC and verify with MAC Address
	 * retrieved using Arp table.
	 * 
	 * @param device The Dut to be validated.
	 * @param tapEnv The {@link AutomaticsTapApi} reference.
	...
	/**
	 * Helper method to get the WebPa value and compare with given SNMP value in
	 * polling duration
	 * 
	 * @param device               {@link device}
	 * @param tapEnv               {@link tapEnv}
	 * @param webPaParam           WebPa parameter name
	 * @param snmpValueToBeMatched value to be matched with the WEBPA response
	 * @param maxDuration          maximum polling duration
	 * @param pollDuration         wait time for each iteration
	 * @return BroadBandResultObject
	 * 
	 */
	...
	/**
	 * Utility method to check whether SSID is enabled for a given parameter. If not
	 * enabled, this method will enable the SSID
	 * 
	 * @param device    The Dut to be validated
	 * @param tapEnv    {@link AutomaticsTapApi} Reference
	 * @param parameter parameter to be enabled
	 ...
	 * @param parameter of wifi either Name or MAC address or Bssid
	...
	public static boolean disableSsidAndVerifyFromDevice(Dut device, AutomaticsTapApi tapApi, String interfaceName,
		...
		if (webPaResonse) {
			...
			if (DeviceModeHandler.isRPIDevice(device)
					&& CommonMethods.isNull(getWifiNameFromDevice(device, tapApi, interfaceName))) {
				LOGGER.info("Null response obtained for Wifi Interface from device when SSID is disabled");
				status = true;
			}
	...
	/**
	 * Method to do polled set of mutliple WebPA parameters, then poll get operation
	 * for specified duration and verify value is set.
	 * 
	 * @param device
	 * @param tapEnv
	...
	/**
	 * Utils method to post/put the details to the table
	 * 'Device.X_RDKCENTRAL-COM_XDNS.DNSMappingTable.' and return the result.
	 * 
	 * @param tapEnv {@link AutomaticsTapApi}
	 * @param device {@link Dut}
	 * @param param  POST/PUT
	 ...
	 * @param listOfWebpaGetParameters List of webpa parameters to execute
	 * @return webpaResponseMap Its return the key and pair value given list of
	 *         webpa parameters
	 */
	...
	/**
	 * Method used to set and verify the Non default values for common web
	 * Parameters
	 * 
	 * @param tapEnv           {@link AutomaticsTapApi}
	 * @param device           {@link Dut}
	 * @param initialMapValues Instance of {Map}
	 * @param setInPostCond    setInPostCond portForwardingEnable should be
	 *                         enabled/disabled when device is in router mode
	 ...
	 * @param tapEnv          {@link AutomaticsTapApi}
	 * @param device          {@link Dut}
	 * @param webPaParameters List of web parameters
	...
	/**
	 * Method to validate the two Map Entries. i.e comparing the key an value pair
	 * both maps
	 * 
	 * @param device          instance of {@link Dut}
	 * @param tapEnv          instance of {@link AutomaticsTapApi}
	 * @param inititalValues  instance of initial map values {@link Map}
	 * @param valuesToCompare instance of current map values {@link Map}
	 ...
	 * 
	 * @param responseMap Instance of {@Map}
	 ...
	 * @param dataType        Data type of the value.
	 * @param valueToBePassed Value that has to be passed.
	 * @param setWaitTime     wait time for parameter to set.
	 * @return status Boolean representing the result of set and get actions.
	 * 
	...
	/**
	 * Utility Method to get webpa parameter response and Partners_Default json
	 * message
	 * 
	 * @param device    The Dut to be used.
	 * @param tapEnv    The {@link AutomaticsTapApi} instance.
	 * @param partnerId The partnerId for which the validation that needs to be
	 *                  done.
	 * @return webPaValueInJson It will return the default value for webpa
	 *         parameters from partners_defaults.json.
	 * 
	 */
	 ...
	 * @param parameters    Array which contains WiFiClient parameters to verify
	 * @param defaultvalues Array which contains default values of WiFiClient
	 *                      parameters
	...
	/**
	 * Utility Method to get values for list of parameters using WebPA command. If
	 * WebPA fails fall back to DMCLI to query same parameters. This method is only
	 * used for setting preconditions.
	 * 
	 * @param device The Dut to be used.
	 * @param tapApi The {@link AutomaticsTapApi} instance.
	 * @return Parameter values which retrieved from WebPA and fall back as DMCLI.
	 ...
	 * @param tapEnv         AutomaticsTapApi instance
	 * @param parameters     Array which contains WiFiClient parameters to verify
	 * @param expectedValues Array which contains expected values of WiFiClient
	 *                       parameters
	...
	/**
	 * Method to change the boolean webpa parameter to a value other than it's
	 * current value
	 * 
	 * i,e toggling the parameter values
	 * 
	 * @ param device device @ param String parameter - webpa parameter whose value
	 * is to be updated
	 * 
	 ...
	 * @param tapEnv    {@link AutomaticsTapApi}
	 * @param device    {@link Dut}
	 * @param parameter TR181 parameter to be verified
	 * @param jsonValue JSON value to be verified
	 * 
