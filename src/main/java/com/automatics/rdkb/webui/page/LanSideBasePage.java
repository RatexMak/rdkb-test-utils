...
public class LanSideBasePage {
	 ...
	 * @param partner               partner Id of the device
	 *
	 * @return true if Captive Portal page is launched
	 * @refactor Govardhan
	 */
	...
	/**
	 * Method to launch any page using the link text & validate the page launch
	 * using the title.
	 * 
	 * 
	 * @param device            Dut instance
	 * @param tapEnv            instance of {@link AutomaticsTapApi}
	 * @param linkText          String representing the link text to be clicked.
	 * @param expectedPageTitle String representing the constant for page title
	 *                          expected after performing the 'click' operation.
	 * 
	 ...
	 * @param linkText          String representing the link text to be clicked.
	 * @param expectedPageTitle String representing the constant of page Title
	 *                          expected after performing the 'click' operation.
	 * 
	 * @return Boolean representing the result of page launch operation.
	 * @refactor Rakesh C N
	 ...
	 * 
	 * @param dropDownXpath     Xpath for DropDown
	 * @param valueToBeSelected Value to be selected from dropdown
	 ...
	 * 
	 * @param xpathForSaveButton   Xpath for Save button to Click
	 * @param popupTitle           Popup Title to verify Alert Title
	 * @param expectedAlertMessage Expected Alert to match with error Message from
	 *                             UI
	...
	/**
	 * Method to launch any page using the Element Id & validate the page launch
	 * using the title.
	 * 
	 * @param device            {@link Dut}
	 * @param tapEnv            {@link AutomaticsTapApi}
	 * @param webElementId      String representing the Xpath of WebElement to be
	 *                          clicked.
	 * @param expectedPageTitle String representing the constant of page Title
	 *                          expected after performing the 'click' operation.
	 * 
	 ...
	 * 
	 * @param linkText          String representing the link text to be clicked.
	 * @param expectedPageTitle String representing the Title of the page expected
	 *                          after performing the 'click' operation.
	 * 
	 * @return Boolean representing the result of page launch operation.
	 ...
	 * @param textBoxBoxXpath Xpath of text box in which value should be entered
