...
public enum BroadBandSnmpMib {
    ...
    ECM_FWUPGRADE_AND_FACTORYRESET_WITHOUT_INDEX(
	    "rdkbRgDeviceFWupdateAndFactoryReset",
    ...
    ECM_DOCSIS_SIGNAL_QUALITY_EXTENDED_RX_MER_TABLE(
    ...
    ECM_PRIVATE_2_4GHZ_SSID_ADVERTISEMENT_ENABLED(
	    ...
	    "10001"),
    ECM_PRIVATE_5GHZ_SSID_ADVERTISEMENT_ENABLED(
