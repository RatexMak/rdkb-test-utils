...
public class BroadBandResetRestoreGatewayPage extends BroadBandBasePage {
	...
	/**
	 * The {@link BroadBandResetRestoreGatewayPage} constructor.
	 * 
	 * @param driver The web driver instance.
	 */

	public BroadBandResetRestoreGatewayPage(WebDriver driver) {
		super(driver);
	 ...
	 * 
	 * @param resetType - reset type of the gateway
	 * 
	...
	public void resetGatewaySettingsBasedOnRequest(RestoreGateWay resetType) {
		...
		try {
			...
			// select okay button
			LOGGER.info("Clicking on 'ok' button to accept PopUp.");
	 ...
	 * 
	 * @param resetType - Gateway reset type
	 * 
